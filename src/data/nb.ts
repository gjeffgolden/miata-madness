...
const colors: PaintColor[] = [
  ...
  },
  {
    ...
    finish: 'solid',
    yearsOffered: [1999, 2000],
    rarityNote:
      'Renamed Pure White for 2001. Earlier revisions of this dataset carried Crystal White ' +
      'through 2005 and gave Pure White a single 2003 year; two independent sources place the ' +
      'rename at 2001.',
  },
  {
  ...
  },
  {
    ...
    finish: 'solid',
    yearsOffered: [2001, 2002, 2003, 2004, 2005],
    rarityNote: 'The 2001 rename of Crystal White, and one of the two 2003 Club Sport colors.',
  },
  {
  ...
  },
  {
    ...
    finish: 'mica',
    yearsOffered: [1999, 2000],
    rarityNote: 'Carried over from the 1997 NA, where it was the STO colour.',
  },
  {
    name: 'Highlight Silver Metallic',
    paintCode: null,
    swatchHex: swatch('#b8bcc0'),
    finish: 'metallic',
    yearsOffered: [1999, 2000],
    rarityNote: 'Replaced by Sunlight Silver Metallic for 2001.',
  },
  {
    name: 'Emerald Mica',
    paintCode: null,
    swatchHex: swatch('#1f4636'),
    finish: 'mica',
    yearsOffered: [1999, 2000, 2001, 2002],
    rarityNote:
      'Miata.net colour lists give this as Emerald Mica across 1999–2002, but write it as ' +
      'Emerald Green Mica in the 2001 and 2002 year listings. Treated here as one colour.',
  },
  {
    name: 'Evolution Orange Mica',
    paintCode: null,
    swatchHex: swatch('#d4541f'),
    finish: 'solid',
    yearsOffered: [2000],
    oneYearOnly: true,
    rarityNote: '2000 Special Edition colour.',
  },
  {
    ...
    finish: 'metallic',
    yearsOffered: [2001, 2002, 2003, 2004],
    rarityNote: 'The 2001 replacement for Highlight Silver Metallic.',
  },
  {
    name: 'Crystal Blue Metallic',
    paintCode: null,
    swatchHex: swatch('#7d9dc4'),
    finish: 'metallic',
    yearsOffered: [2001, 2002],
  },
  {
    name: 'Midnight Blue Mica',
    paintCode: null,
    swatchHex: swatch('#1b2c48'),
    finish: 'mica',
    yearsOffered: [2001, 2002],
  },
  {
    name: 'Splash Green Mica',
    paintCode: null,
    swatchHex: swatch('#5c8f6e'),
    finish: 'mica',
    yearsOffered: [2003],
    oneYearOnly: true,
  },
  {
    name: 'Garnet Red Mica',
    paintCode: null,
    swatchHex: swatch('#7b1f2b'),
    finish: 'mica',
    yearsOffered: [2003],
    oneYearOnly: true,
  },
  {
    name: 'Black Cherry Mica',
    paintCode: null,
    swatchHex: swatch('#3a1520'),
    finish: 'mica',
    yearsOffered: [2004],
    oneYearOnly: true,
  },
  {
    name: 'Razor Blue Metallic',
    paintCode: null,
    swatchHex: swatch('#4a6b91'),
    finish: 'metallic',
    yearsOffered: [2005],
    oneYearOnly: true,
  },
...
export const NB: Generation = {
  ...
  accent: { light: '#215072', dark: '#7FB6E8', colorName: 'Sapphire Blue Mica' },
};
